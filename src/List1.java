...
public class List1 {
    ...
    static void list1(String langName) throws IOException {
        ...
        if (Handler.isListEmpty(langName, 1)) {
            ...
            for (int j = 0; j < Handler.getLength(langName, 1); j++) {
                String[] temp = Files.readAllLines(Paths.get(Main.globPath + langName + Main.list1csv)).get(j).split(";");
        ...
        ListsMenu.listsMenu(langName,"1");
    }
}
