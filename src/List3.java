...
public class List3 {
    ...
    static void list3(String langName) throws IOException {
        ...
        if (Handler.isListEmpty(langName, 3)) {
            ...
            for (int j = 0; j < Handler.getLength(langName, 3); j++) {
                ...
                String[] temp = Files.readAllLines(Paths.get(Main.globPath + langName + Main.list3csv)).get(j).split(";");
        ...
        ListsMenu.listsMenu(langName,"3");
    }
}
